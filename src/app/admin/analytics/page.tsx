...
function Delta({ value, suffix }: { value: number | null; suffix: string }) {
  ...
  return (
    <span
      style={{ fontSize: "0.68rem", color: up ? "var(--ok)" : "var(--err)" }}
    >
...
export default async function AdminAnalyticsPage({
  ...
  const rangeDays =
    range === "0" ? 0 : Math.min(90, Math.max(7, Number(range) || 30));
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      >
        <div>
          ...
          <p className="muted" style={{ marginTop: 2 }}>
            Understand your store, workshop, orders and customer activity at a
            glance.
          </p>
        </div>
        <div className="seg">
      ...
      <div className="admin-card">
        ...
        >
          ...
          >
            ...
            >
              <span
                style={{ width: 10, height: 2, background: "var(--acc)" }}
              />{" "}
              Revenue
            </span>
            <span
            ...
            >
              <span
                style={{
                  ...
                  borderTop: "1px dashed var(--purple)",
                }}
              />{" "}
              Orders
            </span>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {lowStock.map((p) => (
                ...
                >
                  ...
                  <span
                    className={`badge ${p.stock === 0 ? "badge-err" : "badge-warn"}`}
                    style={{ flexShrink: 0 }}
                  >
                    {p.stock} left
                  </span>
                    ...
                    >
                      <div
                        style={{
                          ...
                          background:
                            "linear-gradient(90deg, var(--acc), rgba(201,243,29,0.4))",
                          borderRadius: 99,
                        }}
                      />
                    </div>
              ...
              {workshop.map((w) => (
                <div key={w.name}>
                  ...
                  >
                    ...
                    <b className="num" style={{ flexShrink: 0, marginLeft: 8 }}>
                      {w.count}
                    </b>
                  </div>
                  <div
                  ...
                  >
                    <div
                      style={{
                        ...
                        background:
                          "linear-gradient(90deg, var(--purple), rgba(124,111,242,0.4))",
                        borderRadius: 99,
                      }}
                    />
                  </div>
      ...
      <div className="admin-card">
        ...
        {activity.length === 0 && recentOrders.length === 0 ? (
          <div className="empty">
            <b>Not enough data yet</b>
            Analytics will appear here as orders, customers and workshop
            activity come in.
          </div>
        ) : (
              ...
              <tbody>
                ...
                {activity
                  .filter(
                    (a) =>
                      !recentOrders.some(
                        (o) => o.orderNumber === a.order.orderNumber,
                      ),
                  )
                  .map((a) => (
                    <tr key={a.id}>
