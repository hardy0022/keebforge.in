...
export function PickupLocationCard({
  ...
  return (
    <div className="admin-card">
      ...
      <p
        className="muted"
        style={{ fontSize: "0.8rem", marginBottom: 14, lineHeight: 1.5 }}
      >
        The warehouse from which shipments are picked up. The name is registered
        ...
        {(pending) => (
          <>
            ...
            >
              <Field
                name="name"
                label="Pickup name (warehouse)"
                defaultValue={p.name ?? ""}
                placeholder="e.g. KeebForge HQ"
              />
              <Field
                name="address"
                label="Address"
              ...
              <Field
                name="registeredName"
                label="Registered account name (optional)"
                defaultValue={p.registeredName ?? ""}
                placeholder="Defaults to pickup name"
              />
            </div>
            <div
              style={{
