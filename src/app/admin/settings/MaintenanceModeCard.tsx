        ...
        style={{
          ...
          ...(prominent
            ? {
                ...
                boxShadow:
                  "0 0 0 1px var(--warn), 0 8px 30px -12px color-mix(in srgb, var(--warn) 40%, transparent)",
              }
            : {}),
        }}
      >
      ...
      {confirming && !enabled && (
        ...
        >
          ...
          >
            ...
            >
              {confirmationBody} Admins will still be able to access the admin
              panel.
            </p>
            <p
              style={{
