...
async function RevenueAndPipeline({ rangeDays }: { rangeDays: number }) {
...
async function RecentOrdersAndActivity() {
  const [recentOrders, activity] = await Promise.all([
    getRecentOrders(),
    getRecentActivity(),
  ]);
  return (
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <Suspense fallback={<CardSkeleton />}>
        <RevenueAndPipeline rangeDays={rangeDays} />
      </Suspense>
