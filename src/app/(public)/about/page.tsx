...
const PHILOSOPHY = [
  {
    ...
    desc: "Every modification is approached like an engineering problem, not just a cosmetic upgrade.",
  },
  {
    icon: "🔬",
    title: "Component-Level Repair",
    desc: "Damaged pads, lifted traces, broken USB ports and PCB faults.",
  },
  {
    icon: "🎧",
    title: "Sound Tuning",
    desc: "Foams, stabilizers, switches and acoustics.",
  },
  {
    icon: "📦",
    title: "Mail-in Service",
    desc: "Customers from all over India ship keyboards directly to my workshop.",
  },
];
  ...
  return (
    <main>
      ...
      <section className="svc-section" aria-labelledby="t-philosophy">
        <div className="wrap">
          ...
          <div className="card max-w-[760px]">
            <p className="cd">
              I believe a keyboard should feel consistent across every key.
              Modifications shouldn&apos;t just look custom; they must be
              implemented logically to minimize physical housing stress and
              optimize acoustics layout variables.
            </p>
          </div>
          <div className="grid gap-3 mt-6 max-w-[760px] sm:grid-cols-2">
            <div className="info-card">
              ...
              <p>
                Lubing · Spring swapping · PCB repair · Mill-Max · Firmware ·
                Stabilizer tuning
              </p>
            </div>
            <div className="info-card">
              <h3>The Workshop</h3>
              <p>
                Temperature controlled soldering · ESD protection · Premium
                lubricants
              </p>
            </div>
          </div>
      ...
      <section className="svc-section" aria-labelledby="t-about-keebforge">
        <div className="wrap">
          <SectionHead
            num="03 // About KeebForge"
            title="Built Around Precision"
            desc="KeebForge isn't a reseller. It's a workshop dedicated to mechanical keyboard engineering. Consistency matters."
          />
        ...
        <div className="wrap">
          ...
          <ul className="flex flex-col gap-3 max-w-[720px]">
            {WHY.map((w) => (
              <li
                key={w}
                className="flex gap-3 items-start bg-[var(--bg1)] border border-[var(--bdr)] rounded-[var(--r-sm)] p-4"
              >
                <span className="chk mt-0.5" aria-hidden="true">
                  ✓
                </span>
                <span className="text-[0.85rem] text-[var(--t2)] leading-relaxed">
                  {w}
                </span>
              </li>
            ))}
