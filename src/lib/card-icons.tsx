...
export const CARD_ICONS: Record<CardIconName, CardIconDef> = {
  ...
  cable: {
    ...
    path: (
      <>
        ...
        <path d="M7 7h10l-1 5a4 4 0 0 1-8 0L7 7Z" />
        <path d="M12 16v5" />
      </>
    ),
  },
  ...
  scale: {
    ...
    path: (
      <>
        <path d="M12 3v3M6 6h12" />
        <path d="M6 6 3 14a3.5 3.5 0 0 0 6 0L6 6ZM18 6l-3 8a3.5 3.5 0 0 0 6 0l-3-8Z" />
        <path d="M8 21h8" />
      </>
    ),
  },
...
export function CardIcon({ name }: { name: string }) {
  const def =
    CARD_ICONS[name as CardIconName] ?? CARD_ICONS[CARD_ICON_NAMES[0]];
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
