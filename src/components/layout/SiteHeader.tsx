...
const SHOP_LINKS = [
  {
    href: "/shop/custom",
    label: "Made to Order",
    desc: "Custom products built specifically for you.",
  },
  {
    href: "/shop/products",
    label: "Brand New",
    desc: "New products available from KeebForge.",
  },
  {
    href: "/shop/clearance",
    label: "Clearance",
    desc: "Discounted, open-box & older-stock items.",
  },
];
              ...
              l.href === "/shop" ? (
                ...
                >
                  <Link
                    ...
                    aria-current={
                      isActive(pathname, "/shop") ? "page" : undefined
                    }
                  >
                    {l.label}
                  </Link>
                  ...
                  {shopOpen && (
                    <div className="nav-shop-menu" role="menu">
                      ...
                      >
                        <span className="nav-shop-item-label">
                          All Products
                        </span>
                        <span className="nav-shop-item-desc">
                      ...
                      {SHOP_LINKS.map((s) => (
                        <Link
                          ...
                          role="menuitem"
                          aria-current={
                            isActive(pathname, s.href) ? "page" : undefined
                          }
                          onClick={() => setShopOpen(false)}
                        >
          ...
          <div className="nav-actions">
            ...
            {session ? (
              ...
              <Link
                ...
                aria-label="Sign in"
                title="Sign in"
                onMouseEnter={() => signInIconRef.current?.startAnimation()}
                onMouseLeave={() => signInIconRef.current?.stopAnimation()}
              >
